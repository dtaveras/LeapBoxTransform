/*=========================================================================
  ...
  Module:    vtkLeapBoxRepresentation.h
...
=========================================================================*/
// .NAME vtkLeapBoxRepresentation - a class defining the representation for the vtkBoxWidget2
// .SECTION Description
...
#ifndef __vtkLeapBoxRepresentation_h
#define __vtkLeapBoxRepresentation_h
...
class VTKINTERACTIONWIDGETS_EXPORT vtkLeapBoxRepresentation : public vtkWidgetRepresentation
{
public:
  vtkTextActor* TInfo1;
  void initLeapInfo();
  ...
  vtkSetMacro(LeapInRange,int);
  vtkGetMacro(LeapInRange,int);
...
public:
  ...
  static vtkLeapBoxRepresentation *New();

  // Description:
  // Standard methods for the class.
  vtkTypeMacro(vtkLeapBoxRepresentation,vtkWidgetRepresentation);
...
private:
  vtkLeapBoxRepresentation(const vtkLeapBoxRepresentation&);  //Not implemented
  void operator=(const vtkLeapBoxRepresentation&);  //Not implemented
};
