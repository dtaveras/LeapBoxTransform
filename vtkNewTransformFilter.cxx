/*=========================================================================
  ...
  Module:    vtkNewTransformFilter.cxx
...
=========================================================================*/
#include "vtkNewTransformFilter.h"
...
vtkStandardNewMacro(vtkNewTransformFilter);
vtkCxxSetObjectMacro(vtkNewTransformFilter,Transform,vtkAbstractTransform);

vtkNewTransformFilter::vtkNewTransformFilter()
{
  this->Transform = NULL;
}
...
int vtkNewTransformFilter::FillInputPortInformation(int vtkNotUsed(port),
                                                 vtkInformation *info)
{
...
int vtkNewTransformFilter::RequestDataObject(vtkInformation *request,
...
int vtkNewTransformFilter::RequestData(
...
unsigned long vtkNewTransformFilter::GetMTime()
{
...
void vtkNewTransformFilter::PrintSelf(ostream& os, vtkIndent indent)
{
