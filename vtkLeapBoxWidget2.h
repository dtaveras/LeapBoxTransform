...
=========================================================================*/
// .NAME vtkLeapBoxWidget2 - 3D widget for manipulating a box
// .SECTION Description
// This 3D widget interacts with a vtkLeapBoxRepresentation class (i.e., it
...
// object rotation or scaling. A nice feature of vtkLeapBoxWidget2, like any 3D
// widget, will work with the current interactor style. That is, if
// vtkLeapBoxWidget2 does not handle an event, then all other registered
// observers (including the interactor style) have an opportunity to process
// the event. Otherwise, the vtkBoxWidget will terminate the processing of
// the event that it handles.
//
// To use this widget, you generally pair it with a vtkLeapBoxRepresentation
...
// into the vtkLeapBoxWidget2's widget events:
// <pre>
...
// </pre>
//
// In turn, when these widget events are processed, the vtkLeapBoxWidget2
...
//
// This class, and the affiliated vtkLeapBoxRepresentation, are second generation
// VTK widgets. An earlier version of this functionality was defined in the
// class vtkBoxWidget.

// .SECTION See Also
// vtkLeapBoxRepresentation vtkBoxWidget

#ifndef __vtkLeapBoxWidget2_h
#define __vtkLeapBoxWidget2_h

#include "vtkInteractionWidgetsModule.h" // For export macro
#include "vtkAbstractWidget.h"

class vtkLeapBoxRepresentation;
class vtkHandleWidget;

class VTKINTERACTIONWIDGETS_EXPORT vtkLeapBoxWidget2 : public vtkAbstractWidget
{
public:
  vtkWidgetRepresentation* GetWidgetRep();
public:
  // Description:
  // Instantiate the object.
  static vtkLeapBoxWidget2 *New();
  // Description:
  // Standard class methods for type information and printing.
  vtkTypeMacro(vtkLeapBoxWidget2,vtkAbstractWidget);
  ...
  void SetRepresentation(vtkLeapBoxRepresentation *r)
  ...
  // this is an instance of the vtkLeapBoxRepresentation class.
...
private:
  vtkLeapBoxWidget2(const vtkLeapBoxWidget2&);  //Not implemented
  void operator=(const vtkLeapBoxWidget2&);  //Not implemented
};
